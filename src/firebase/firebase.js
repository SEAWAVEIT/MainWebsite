...
import { getFirestore, collection, addDoc, getDoc, deleteDoc, getDocs, updateDoc, doc } from 'firebase/firestore';
...
export { db, auth, googleProvider, signInWithPopup, collection, getDoc, storage, getDocs, addDoc, deleteDoc, doc, updateDoc };
