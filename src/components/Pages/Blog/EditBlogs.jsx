    ...
    return (
        <div className="flex flex-col bg-white py-16 px-6 md:px-12 mx-auto max-w-7xl">
            <div className="text-center mb-8">
                <h1 className="text-4xl font-bold text-gray-900 mb-4">Edit Blogs</h1>
                ...
                <div className="grid grid-cols-1 gap-6 ">
                    {posts.map((post) => (
                        ...
                        >
                            ...
                            <div>
                                <button onClick={() => editBlog(post.id)} className='btn btn-sm hover:bg-blue-600 bg-blue-500 text-white'>Edit</button>
                            </div>
                            <div>
                                <button
                                    onClick={(e) => {
                                    ...
                                    className='btn btn-sm hover:bg-red-600 bg-red-500 text-white'>Delete
                                </button>
                            </div>
                        </div>
                    ))}
